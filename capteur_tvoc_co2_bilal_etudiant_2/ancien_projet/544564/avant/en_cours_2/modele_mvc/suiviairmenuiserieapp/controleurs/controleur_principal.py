...
class Controleur:
    ...
    def __init__(self,manager):
        ...
        # Mise à jour automatique des données CO2 et TVOC toutes les 10 secondes
        Clock.schedule_interval(self.mettre_a_jour_co2_tvoc, 10)
    ...
    def mettre_a_jour_co2_tvoc(self, *args):
        ...
        if self.ihm_accueil is not None:
            ...
            print("⚠️ ihm_accueil n'est pas défini. Assurez-vous que set_ihm_accueil a été appelé.")
