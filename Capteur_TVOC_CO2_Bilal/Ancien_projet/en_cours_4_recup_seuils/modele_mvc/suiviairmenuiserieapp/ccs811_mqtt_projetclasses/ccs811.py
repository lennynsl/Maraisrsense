...
class CCS811:
    ...
    def print_error(self):
        ...
        """
        error = self.i2c.readfrom_mem(CCS811_ADDR, CCS811_ERROR_ID, 1)[0]
    ...
    def check_for_error(self):
        ...
        """
        status = self.i2c.readfrom_mem(CCS811_ADDR, CCS811_STATUS, 1)[0]
    ...
    def set_drive_mode(self, mode):
        ...
        setting = self.i2c.readfrom_mem(CCS811_ADDR, CCS811_MEAS_MODE, 1)[0]
        setting &= ~(0b00000111 << 4)  # Réinitialise les bits de mode
        setting |= (mode << 4)  # Définit le nouveau mode
        self.i2c.writeto_mem(CCS811_ADDR, CCS811_MEAS_MODE, setting)
    ...
    def configure_ccs811(self):
        ...
        """
        hardware_id = self.i2c.readfrom_mem(CCS811_ADDR, CCS811_HW_ID, 1)[0]
        if hardware_id != 0x81:
        ...
        self.i2c.writeto(CCS811_ADDR, bytes([CCS811_APP_START]))
    ...
    def get_base_line(self):
        ...
        """
        data = self.i2c.readfrom_mem(CCS811_ADDR, CCS811_BASELINE, 2)
    ...
    def read_logorithm_results(self):
        ...
        """
        data = self.i2c.readfrom_mem(CCS811_ADDR, CCS811_ALG_RESULT_DATA, 4)
