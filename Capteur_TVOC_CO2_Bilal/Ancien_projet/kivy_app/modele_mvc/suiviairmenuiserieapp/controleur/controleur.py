...
class VueAccueil(Screen):
    ...
    def afficher_co2_tvoc(self, val1, val2, alertes, moyenne_jour=None, seuils_mis_a_jour=False):
        ...
        :param seuils_mis_a_jour: Booléen, True si les seuils ont été mis à jour
        """
        ...
        # Correction : priorité à l'affichage du message "Seuils mis à jour"
        if "alerte_capteur" in self.ids and seuils_mis_a_jour:
            self.ids.alerte_capteur.text = "Nouveaux seuils reçus du serveur MQTT !"
            self.ids.alerte_capteur.color = (1, 0, 0, 1)
            # On sort immédiatement pour éviter d'écraser ce message
            return
        ...
        # Correction : effacement des alertes déplacé hors du bloc précédent
