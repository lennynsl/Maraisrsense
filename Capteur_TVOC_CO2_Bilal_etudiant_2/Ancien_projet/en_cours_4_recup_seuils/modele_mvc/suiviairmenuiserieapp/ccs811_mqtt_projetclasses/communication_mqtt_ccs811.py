...
class CommunicationCCS811:
    ...
    (Uniquement CCS811 désormais)
    """
    def __init__(self, adresse_du_broker, port_connexion, client_identification, mots_de_passe):
        """
        Initialise la connexion au broker MQTT et définit le client.
        
        :param adresse_du_broker: Adresse du broker MQTT
        ...
        """
        self.adresse_du_broker = adresse_du_broker
        ...
        with warnings.catch_warnings():
            ...
            self.client = mqtt.Client(
                client_id=client_identification, protocol=mqtt.MQTTv311
            )
        self.client.username_pw_set(
            username=self.client_identification, password=self.mots_de_passe
        )
        self.client.tls_set(cert_reqs=ssl.CERT_NONE)
        self.client.tls_insecure_set(True)
        self.client.connect(self.adresse_du_broker, self.port_connexion)
